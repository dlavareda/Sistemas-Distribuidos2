...
public class Connection extends Thread {
	...
	public synchronized void run() {
		while (clientesAtivos.incrementAndGet() > maxClientes) { //Fica em wait se o numero de processos ativos exceder o máximo definido
		...
		try
		{
			...
			//criado para testar o limite de clientes
			try {
				sleep(1000);
			...
			System.out.println(clientesAtivos.decrementAndGet());
			notifyAll(); //notifica fim do processo
			os.close();
			is.close();
